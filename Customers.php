...
/* $Id: Customers.php 7751 2017-04-13 16:34:26Z rchacon $ */
...
if (isset($_POST['submit'])) {
	...
	elseif (mb_strlen($_post['phoneNumber'])>15){
		$InputError = 1;
		prnMsg( _('The Line 8 of the address must be fifteen characters or less long'),'error');
...
/* First check that all the necessary items have been setup */
	...
	echo '<tr>
		...
		// ADD PHONE NUMBER IN CUSTOMER PAGE 
		
		echo '<tr>
				<td>' ._('phone Number') . ':</td>
				<td><input tabindex="8" type="text" class="integer" name="phoneNumber" size="22" maxlength="20" /></td>
			 </tr>';
